# Tactical Todo — Updated 2026-06-12 16:35Z (Friday 12:35 PM ET)
...
- **Account equity / cash / buying power:** ~$9,770 / ~$8,407 / ~$37,443
- **Gross long exposure:** ~13.95% | **Net exposure:** ~13.95% | **Cash:** ~86.05%
- **Daytrade count:** 0/3 (official Alpaca count)
- **Pattern day trader:** false
- **Open orders:** NONE
- **Market:** OPEN until 20:00Z. Next tactical: 16:40Z. Next hourly: 17:35Z (1:35 PM ET).
...
- **Fresh macro risk:** Iran de-escalation continues + cooler PPI + SpaceX IPO risk-on = bullish macro shift. Market slightly lower from 15:35Z but still positive on day. Do not chase.
- **Event detector:** NONE at 16:35Z. Prior CRITICAL semi melt-up (14:10Z) fully resolved.
- **Autonomous override:** RESOLVED at 15:36Z. SOXX buy trigger ACTIVE.
- **Blocker preventing deployment:** All actionable setups in the universe are trading well above their positive-EV entry triggers. QQQ at $720.72 (needs ≤$690 for 2:1 R/R). SOXX at $599.09 (needs ≤$523 for 2:1 R/R). No other symbol in the universe has a confirmed setup with R/R ≥ 2:1. Cash will remain elevated until the market provides a discount or a new positive-EV setup emerges.

## Position Instructions — Fri Jun 12 (:40, :50 Tactical Runs)

### VOO — HOLD 2 — DO NOT SELL OR ADD
- Weight ~13.95%, below 20% non-QQQ ETF cap. Adding 1 share at current price ($681.355) would breach cap (~21.0% of equity = code-rejected).
...
- Current price ~$720.72. Market up +0.41% today after +2.8% yesterday. Do NOT chase.
...
- **Concentration cap check:** QQQ max 45% of equity = $4,396.33. Buying 2 shares at $689.50 = $1,379 = 14.1% of equity. Well within cap.
...
- Current price ~$599.09. Market up +1.95% today after +5.9% yesterday. Do NOT chase. SOXX is the most volatile in our universe and is in a sharp decline (–1.85% on week, but bouncing). Barrons: "AI Rally Keeps Unwinding." Oracle AI spending fears (-12%) add spillover risk.
...
- **Concentration cap check:** SOXX max 20% of equity = $1,953.92. Buying 1 share at $522.50 = 5.4% of equity. Well within cap.
- **DO NOT buy SOXX above $523.00.** Buying back above our lowest sell price ($523.12) is poor execution.
- **Illiquidity warning:** SOXX is very thin (3 trades, 190 vol at 16:34Z). Use limit orders only. No market orders.

### NVDA — DO NOT BUY — DO NOT RE-BUY
- Fully exited June 5 at $207.80. Current price $205.07. No re-entry authorized.
...
- Fully exited June 1 at $370.50. Current price $359.635. No re-entry authorized.
- No clear catalyst. Await hourly authorization.

### AVGO — DO NOT BUY — DO NOT RE-BUY
- Fully exited June 4 at $405.16. Current price $380.86. Post-earnings correction deepening.
...
- GLD trade count 2, volume 82 at 16:34Z — acceptable but limit orders only, or defer.
...
- **If event detector flags MAJOR or CRITICAL event on broad market symbols (SPY, QQQ, SOXX, XLK, SMH), suspend buys and execute protective sells only if stop-loss is breached.** Current classification: NONE at 16:35Z. All buy triggers ACTIVE. No protective sells required.
...
- **SOXX:** Very thin (3 trades, 190 vol at 16:34Z). Limit orders only.
- **GLD:** Thin (2 trades, 82 vol at 16:34Z). Limit orders only, or defer.
...
5. **If no triggers hit:** Hold VOO 2. Maintain cash. Reassess on next hourly run (17:35Z / 1:35 PM ET).

## Expected Book
- VOO 2 (~13.95%)
- Cash: ~$8,407 (~86.05%)
- Gross exposure: ~13.95%
- If QQQ limit buy fills: VOO 2 + QQQ 2 = ~27.9% gross. Cash ~$7,028.
- If both limit buys fill: VOO 2 + QQQ 2 + SOXX 1 = ~33.3% gross. Cash ~$5,406.

## Next Hourly Preview — 17:35Z (1:35 PM ET) (NOT AUTHORIZED YET)
