# Tactical Todo — Updated 2026-05-28 18:35Z (Thursday 2:35 PM ET)
...
- **Account equity / cash / buying power:** $10,204.31 / $1,670.50 / $11,874.81
- **Gross long exposure:** 83.63% | **Net exposure:** 83.63% | **Cash:** 16.37%
...
- Weight ~43.26%, within 45% cap. Adding 1 share would breach cap.
- Intraday action positive (+0.86% today). Let core position run.

### GOOG — HOLD 3 — DO NOT SELL OR ADD UNLESS HOURLY EXPLICITLY AUTHORIZES
- Weight ~11.37%, within 15% cap. Adding 1 share would breach cap (~15.16%).
- Price $386.83, below avg entry $392.92. Reclaimed $385 but still weak.
...
- Weight ~13.60%, within 20% non-QQQ ETF cap. Adding 1 share would breach 20% cap (~20.36%).
- Broad-market anchor. No action required.

### SOXX — HOLD 2 — DO NOT ADD
- Weight ~11.21%, within 20% non-QQQ ETF cap.
- 2nd share bought May 27 at $567.99; price now $571.87 (+0.68% from entry on that lot). Overall position unrealized +3.80%.
...
- Position opened May 27 at ~$427.37. Price now $427.68 (+0.07% from entry).
...
- **Re-entry is NOT authorized in this todo.** The 2:35 PM ET hourly explicitly DEFERRED NVDA re-entry.
- Price $214.49 remains below $215 reclaim threshold. Weak 1W (–4.07%) vs SOXX (+9.85%). $150B capex plan announced but stock has not reacted positively.
- Tactical agent must NOT place a NVDA buy order at any tactical run. Any attempt is unauthorized.
- If the 3:35 PM ET hourly authorizes re-entry, it will provide explicit price and confirmation conditions.
...
1. **NO ORDERS AUTHORIZED** for the 2:35 PM ET hourly cycle.
2. **Next potential action (3:35 PM ET hourly):** Final pre-close evaluation. NVDA re-entry ONLY if price reclaims $215 with volume AND confirmation OR pulls back to ~$208 with a bounce. Otherwise continue hold-all posture.
