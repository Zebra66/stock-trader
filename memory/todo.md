# Tactical Todo — Updated 2026-07-16 19:35Z (Thu 3:35 PM ET hourly)
*Market **OPEN** (~25m to close). Book: QQQ 6 / VOO 4 / AVGO 1 / HOOD 1. Event detector **NONE**. HOLD-ONLY. No discretionary buys. No after-hours.*

## MARKET OPEN — HOURLY DIRECTIVES (3:35 PM ET — FINAL SESSION HOURLY)
...
- Soft chip / AI-valuation tape into the close; do not buy residual dips.
...
- **No active sell triggers remain.** HOLD-ONLY through 4:00 PM ET close.
- **No after-hours / pre-market orders** at/after 4:00 PM ET.
- Next full reassess: **Fri open / first Fri hourly**.

## TURNOVER: 0/2 discretionary trades used today, ~27.1% of 20% weekly budget used (WEEKLY EXCEEDED)
- Mon–Tue ~$2,095 notional + today AVGO protective trail **$380.65** + HOOD trail **$107.51** ≈ **$2,583** (~27.1% of equity).
...
- **Live book:** QQQ 6 @ ~$704.1 | VOO 4 @ ~$688.2 | AVGO 1 @ ~$375.8 | HOOD 1 @ ~$106.1
- **Equity / cash:** ~$9,541 / ~$2,082
- **Gross:** **~78.2%** | Cash **~21.8%** (cap-bound + weekly TO)
- **Daytrade count:** **0** | **Open orders:** NONE
- **Audit:** clean

## Exact cash blocker
1. Weekly TO **~27.1% > 20%** → no discretionary buys (binds through Sun Jul 19).
2. VOO room ~**$110** < 1 share (~$688).
3. QQQ room ~**$69** < 1 share (~$704).
4. Soft chip / AI-valuation digestion into close; thin ETFs — do not buy.
5. No single-name add edge that beats do-nothing VOO baseline after friction.

## Ranked Execution Priority (Thu close → Fri open)
1. **All active triggers executed.** Remaining book: HOLD only through close.
2. **Everything else: no trades.**
3. After 4:00 PM ET: **no orders** (no AH / pre-market).
...
- Core. No stop. Soft Nasdaq into close is not a sell signal. No action.

### AVGO — HOLD 1 — TRAIL ALREADY EXECUTED 09:40 ET — DO NOT ADD / DO NOT RE-BUY
- **Trail executed:** SOLD 1 at **$380.65**. 1 share remains.
- Remaining 1 share avg entry **$371.95**; current ~$375.8; unrealized ~+1.0%.
...
- Remaining 1 share avg entry **$101.50**; current ~$106.1; unrealized ~+4.5%.
...
- Next hourly reassesses weekly TO + cap room + detector (Fri open).
...
## Safeguards
- HOLD-ONLY through close. No remaining authorized sells. No discretionary buys.
...
- **Final ~25 minutes of session:** do not invent last-minute trades. Hold through close.

## Current Book
- QQQ 6 (~44.3%), VOO 4 (~28.8%), AVGO 1 (~3.9%), HOOD 1 (~1.1%)
