# Tactical Todo — Updated 2026-06-11 17:35Z (Thursday 1:35 PM ET)

## Current State
- **Regime:** defensive (30–50% gross exposure target band, intent to hold cash until stabilization)
- **Live book:** VOO 2 only
- **Account equity / cash / buying power:** ~$9,757 / ~$8,407 / ~$18,156
- **Gross long exposure:** ~13.83% | **Net exposure:** ~13.83% | **Cash:** ~86.17%
- **Daytrade count:** 0/3 (official Alpaca count)
- **Pattern day trader:** false
- **Open orders:** NONE
- **Market:** OPEN until 20:00Z. Next hourly: Thu Jun 11 18:35Z (2:35 PM ET). ~60 minutes to next hourly.
...
- **Event detector:** MAJOR at 17:35Z (GLD +1.21% in 10 min). Prior CRITICAL at 17:30Z resolved. Broad market calm. Buy suspension LIFTED.

## Position Instructions — Thu Jun 11

### VOO — HOLD 2 — DO NOT SELL OR ADD
- Weight ~13.83%, at 20% non-QQQ ETF cap. Adding 1 share at current price ($674.86) would breach cap (20.6% of equity = code-rejected).
...
- Current price ~$710.08. Market up +2.35% today. Do NOT chase.
- **Trigger:** BUY **2 shares** if price drops to **$690.00 or below**. Place limit order at **$689.50**. RE-AUTHORIZED — CRITICAL event resolved.
...
- **Concentration cap check:** QQQ max 45% of equity = $4,390. Buying 2 shares at $689.50 = $1,379 = 14.1% of equity. Well within cap.
...
- Current price ~$572.82. Market up +5.59% today. Do NOT chase. SOXX is the most volatile in our universe and is in a sharp decline (–5.14% on week). Barrons: "AI Rally Keeps Unwinding." Oracle AI spending fears (-12%) add spillover risk.
- **Trigger:** BUY **1 share** if price drops to **$523.00 or below**. Place limit order at **$522.50**. RE-AUTHORIZED — CRITICAL event resolved.
...
- **Concentration cap check:** SOXX max 20% of equity = $1,951. Buying 1 share at $522.50 = 5.4% of equity. Well within cap.
- **DO NOT buy SOXX above $523.00.** Buying back above our lowest sell price ($523.12) is poor execution.
- **Illiquidity warning:** SOXX is thin (31 trades, 1,449 vol at 17:34Z). Use limit orders only. No market orders.

### NVDA — DO NOT BUY — DO NOT RE-BUY
- Fully exited June 5 at $207.80. Current price $202.64. No re-entry authorized.
...
- Fully exited June 1 at $370.50. Current price $349.58. No re-entry authorized.
- Down 8.83% on month. No clear catalyst. Await hourly authorization.

### AVGO — DO NOT BUY — DO NOT RE-BUY
- Fully exited June 4 at $405.16. Current price $382.68. Post-earnings correction deepening.
...
- GLD trade count 11, volume 2,750 at 17:34Z — thin. Limit orders only if ever authorized.
...
- **If event detector flags MAJOR or CRITICAL event on broad market symbols (SPY, QQQ, SOXX, XLK, SMH), suspend buys and execute protective sells only if stop-loss is breached.** Current classification: MAJOR (GLD only). Broad market OK. Buy suspension LIFTED.
...
- **SOXX:** Thin (31 trades, 1,449 vol at 17:34Z). Limit orders only.
- **GLD:** Thin (11 trades, 2,750 vol at 17:34Z). Limit orders only, or defer.
...
5. **If no triggers hit:** Hold VOO 2. Maintain cash. Reassess on next hourly run (Thu 2:35 PM ET).

## Expected Book
- VOO 2 (~13.83%)
- Cash: ~$8,407 (~86.17%)
- Gross exposure: ~13.83%
