...
- **Account equity / cash / buying power:** $10,405.74 / $1,777.45 / $12,183.19
- **Gross long exposure:** ~82.92% | **Net exposure:** ~82.92% | **Cash:** ~17.1%
- **Daytrade count:** 0/3
...
## Position Instructions — Tue June 2 (:40 and :50 Tactical Runs; final hourly at 19:35Z already executed)
...
- Unrealized +8.42% from avg $554.51.
...
- Position blended avg $435.92. Current price ~$477.97 (unrealized +9.65%).
- Pre-earnings catalyst (earnings June 3, Wed after close — binary event in ~25 hours). Custom silicon thesis validated by broader chip rally.
...
- Current price ~$360.65. Well below $385 reclaim threshold.

### NVDA — DO NOT BUY — DO NOT RE-BUY
- Fully exited May 27. Re-entry deferred. NVDA at ~$222.51 after pullback from earlier highs.
...
- **No discretionary buys this cycle or into the close.** Gross exposure is 82.92%; adding any share pushes toward 90% upper bound and is blocked by concentration caps or earnings risk.
...
## Next Hourly Preview — Wed Jun 3 13:35Z (9:35 AM ET) (NOT AUTHORIZED YET)
- Review AVGO momentum into earnings (June 3 after close — ~8 hours from 9:35 AM ET open).
