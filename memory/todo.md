...
## Existing Positions
- [ ] **HOLD AVGO** — target allocation **~4%** is already filled. **Do not add.** **TRIM / SELL 1 share** above **422.0** on regular-hours strength through the 5-day high zone, or **SELL 1 share** below **399.5** to cut risk on a loss of short-term support.
- [ ] **HOLD QQQ** — target allocation **~7%** is already filled. **Do not add.** **TRIM / SELL 1 share** above **675.0** if momentum extends through the recent high, or **SELL 1 share** below **657.0** on a break of the recent 5-day low zone.
- [ ] **HOLD SOXX** — current size is already near the desired **~9%** target allocation. **Do not add.** **TRIM 1 share** above **466.5** if strength extends through recent resistance, or **SELL 1 share** below **438.5** if the recent breakout structure fails.
- [ ] **HOLD QTUM** — current size is already near the desired **~3%** target allocation. **Do not add.** **TRIM 1 share** above **137.0** if regular-hours upside extends through the recent high, or **SELL 1 share** below **128.5** to cut risk on a loss of short-term support.
- [ ] **HOLD RKLB** — keep this as a tiny satellite only. **TRIM / SELL 1 share** above **82.8** if strength extends, or **SELL 1 share** below **76.8** to cut risk on a deeper pullback.

## Active Buy / Sell Conditions For New Capital
- [ ] **BUY GOOG** only if price breaks above **384.0** during regular hours and holds with confirmation, or if it pulls back into **372.0-375.0** and then reclaims **376.0** on the same session. Because the latest broker after-hours print had only **1 trade**, require either **regular-hours confirmation** or a **second-source quote check** before acting. Start with **1 share** (~3.8% of equity).
...
- [ ] **AVOID HOOD** unless a future hourly cycle explicitly upgrades it; setup quality remains inferior and Reuters-linked earnings coverage stayed weak.
