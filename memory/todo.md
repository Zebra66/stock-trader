# Tactical Todo — Updated 2026-06-01 14:35Z (Monday 10:35 AM ET)
...
- **Account equity / cash / buying power:** ~$10,220 / ~$1,777 / ~$11,997
- **Gross long exposure:** ~82.6% | **Net exposure:** ~82.6% | **Cash:** ~17.4%
- **Daytrade count:** 0/3
- **Pattern day trader:** false
- **Open orders:** NONE
- **Market:** OPEN until 16:00 ET.

## Position Instructions — Mon June 1 (:50 Tactical Run)
...
- Unrealized +2.58% from avg $554.51. Today flat after prior run.
...
- Position blended avg $435.92. Current price ~$456.08 (unrealized +4.63%). Today +2.18%.
...
- Fully exited May 27. Re-entry deferred. NVDA rallied +4.65% today on Computex news to ~$221.
...
- QQQ 6 (~43.4%), SOXX 3 (~16.7%), VOO 2 (~13.6%), AVGO 2 (~8.9%)
- Cash: ~$1,777 (~17.4%)
- Gross exposure: ~82.6%
