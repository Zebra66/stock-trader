# Tactical Todo — Updated 2026-07-01 18:35Z (Wednesday 2:35 PM ET)
*Market OPEN. Next hourly: 19:35Z (3:35 PM ET).*
...
- **Account equity / cash / buying power:** $9,670.40 / $1,950.98 / $29,418.30
- **Gross long exposure:** 79.8% | **Net exposure:** 79.8% | **Cash:** 20.2%
- **Daytrade count:** 0/3 (clean slate)
- **Pattern day trader:** false
- **Open orders:** NONE.
- **Market:** OPEN. Next hourly: 19:35Z (3:35 PM ET).
- **Daily trade budget:** 1/3 filled today (RKLB limit buy filled at 14:58Z).
- **Macro note:** SOXX down –6.17% today (prior close $640.76 → current ~$601.36). Major chip-sector rout. AVGO showing relative strength (–1.89% vs SOXX –6.17%). Monitor AVGO $368 low and SOXX $600.

## HOLD Instructions — Active During Wednesday Regular Session

### QQQ — HOLD 5 shares
- **Entry:** Avg $715.38 (filled Jun 29 morning)
- **Current:** $727.37 (+1.68% unrealized)
...
- **Concentration:** 37.6% of equity. Under 45% cap. Adding 1 share would breach cap (45.1%). No adds.
...
- **Current:** $686.86 (+1.54% unrealized)
...
- **Current:** $370.64 (–0.35% unrealized)
...
- **Rationale:** AI chip alpha. Slightly underwater but showing relative strength vs SOXX rout (–1.9% vs –6.2%). Breakeven is $371.95. Selling at breakeven or small loss is PROHIBITED without hourly authorization. **Monitor $368.00 (today's low). If AVGO breaks below $368, reassess at next hourly.**
...
- **Current:** $107.795 (+6.20% unrealized)
...
- **Rationale:** 4th position. Strong 1M/3M momentum. Surging today +7.4%. Breakeven is $101.50. Selling at breakeven or small profit is PROHIBITED without hourly authorization.
- **Concentration:** 11.1% of equity. Under 15% cap. Adding 1 share would add ~1.1% to weight. No adds authorized today.
- **Liquidity note:** HOOD is thin. LIMIT ORDER ONLY.
...
- **Current:** $103.77 (+5.89% unrealized)
...
- **Profit target:** $115.00. Do NOT trim or sell below $115 without fresh hourly authorization.
- **Rationale:** 5th position. Space-sector M&A thesis ($8B Iridium deal). Wedbush "best time in a generation" for space/defense validates. Pullback from $106.54 to $103.77 is normal profit-taking. Breakeven is $98.00. Selling at breakeven or small profit is PROHIBITED without hourly authorization.
...
### HOOD — DO NOT BUY
- **Reason:** Already hold 10 shares. No add authorized.
...
### QQQ — DO NOT ADD
- **Reason:** At 37.6% of equity. Adding 1 share would push QQQ to ~45.1%, breaching 45% cap.
...
### HOOD — DO NOT ADD
- **Reason:** At 11.1% of equity. No add authorized today.
- **DO NOT BUY HOOD** today.

## DO NOT BUY — Symbols Blocked This Cycle

### SOXX — DO NOT BUY
- **Reason:** Down –6.17% today (major chip rout). Prior close $640.76, current ~$601.48. Watch $600/$590. Do NOT buy into a falling knife. Overlaps QQQ/AVGO.
- **DO NOT BUY SOXX** today.

### NVDA — DO NOT BUY
- **Reason:** Below 50-day MA. Down –0.85% today. No edge over AVGO.
...
- **HOOD:** 15 trades at 18:34Z. Very thin. LIMIT ORDER ONLY.
- **RKLB:** 43 trades at 18:34Z. Acceptable but limit orders preferred.
- **EIS / ARKX / GLD / QTUM:** Very low trade count / volume. Limit orders only.
- **SHLD:** 1 trade at 18:30Z. Limit orders preferred.
- **VOO:** 1 trade at 18:31Z but liquid underlying. Limit orders only.
- **SOXX:** 7 trades at 18:34Z. Acceptable but limit orders preferred.
- **AVGO:** 17 trades at 18:34Z. Acceptable but limit orders preferred.

## Current Book
- **Open orders (pending fill):** NONE
- **Filled positions today:** RKLB 5 shares limit buy @ $98.00 (filled 14:58Z)
- Cash: $1,950.98 (20.2%)
- Gross exposure: 79.8%

## Next Hourly — Wednesday Jul 1 19:35Z (3:35 PM ET)
...
- **Watch AVGO $368.00.** If AVGO breaks below today's low ($368.03), chip weakness is spreading. Hourly strategist will reassess.
