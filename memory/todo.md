# Tactical Todo — Updated 2026-07-16 17:10Z (Thu 1:10 PM ET tactical)
...
- HOOD trail **executed** at ~1:10 PM ET at $107.51 (limit $107.50); 1 share remains.
- AVGO 9:40 trail already executed; no active sell triggers remain.

## TURNOVER: 0/2 discretionary trades used today, ~26.9% of 20% weekly budget used (WEEKLY EXCEEDED)
- Mon–Tue ~$2,095 notional + today AVGO protective trail **$380.65** + HOOD trail **$107.51** ≈ **$2,583** (~26.9% of equity).
...
- **Live book:** QQQ 6 @ ~$708.6 | VOO 4 @ ~$691.8 | AVGO 1 @ ~$377.9 | HOOD 1 @ ~$107.8
- **Equity / cash:** ~$9,587 / ~$2,082
- **Gross:** **~78.3%** | Cash **~21.7%** (cap-bound + weekly TO)
- **Daytrade count:** **0** | **Open orders:** NONE
- **Audit:** clean

## Exact cash blocker
1. Weekly TO **~26.9% > 20%** → no discretionary buys.
...
- Remaining 1 share avg entry **$101.50**; current ~$107.8; unrealized ~+6.2%.
