# Tactical Todo — Updated 2026-06-15 17:35Z (Monday 1:35 PM ET)
*HARD_LOCK LIFTED. GOOG buy CANCELLED. QQQ + SOXX buys ACTIVE. Market OPEN until 20:00Z (16:00 ET). ~2.4 hrs to close. Next tactical: ~17:40Z. Next hourly: 18:35Z (2:35 PM ET).*

## Current State
- **Regime:** offensive catch-up (60–90% gross exposure target band, intent to deploy on confirmed pullbacks)
- **Live book:** VOO 2, AVGO 1
- **Account equity / cash / buying power:** $9,798.93 / $8,015.48 / $34,733.05
- **Gross long exposure:** 18.20% | **Net exposure:** 18.20% | **Cash:** 81.80%
- **Daytrade count:** 0/3 (official Alpaca count)
- **Pattern day trader:** false
- **Open orders:** 2 limit buys open (unfilled): QQQ 2@$689.50 GTC (restored 16:33Z), SOXX 1@$575.00 GTC (restored 16:33Z). GOOG 1@$368.50 day was **CANCELLED** at 17:35Z.
...
- **Event detector:** NONE at 17:35Z. Broad market OK.
- **Blocker preventing deployment:** QQQ and SOXX are >7% above our triggers ($744 vs $690, $627 vs $575). Market is rallying hard with no pullbacks. GOOG was cancelled due to poor R/R (1.1R < 2.0R minimum). No chasing authorized.

## Position Instructions — Monday Jun 15 (1:35 PM ET)

### VOO — HOLD 2 — DO NOT SELL OR ADD
- Weight 14.18%, below 20% non-QQQ ETF cap. Adding 1 share at current price (~$695.15) would breach cap (~21.3% of equity = code-rejected).
...
- Current price ~$744.04. Market up +3.91% 1W. Do NOT chase.
...
- **Concentration cap check:** QQQ max 45% of equity = $4,409.52. Buying 2 shares at $689.50 = $1,379 = 14.1% of equity. Well within cap.
...
- Current price ~$626.97. Market up +9.71% 1W. Do NOT chase.
...
- **Concentration cap check:** SOXX max 20% of equity = $1,959.79. Buying 1 share at $575.00 = 5.87% of equity. Well within cap.
- **Buying at $575 is NOT chasing.** It is 8.29% below current and is a confirmed pullback entry.
- **Illiquidity warning:** SOXX is thin (3 trades, 295 vol at 17:34Z). Limit orders only. No market orders. Maximum 1 SOXX order authorized; do not place additional orders.

### GOOG — DO NOT BUY — DO NOT RE-BUY
- Fully exited June 1 at $370.50. Current price $369.83 — below our prior sell price.
- Down –6.88% 1M. No clear catalyst, but beaten-down mega-cap.
...
- **Position:** 1 share filled at $391.43 (16:47Z). Current price $393.15.
- Post-earnings correction deepening. Down –10.62% 1M.
...
- **Concentration cap check:** AVGO max 15% of equity = $1,469.84. Current position 1 share = 4.01% of equity. Well within cap.

### RKLB — DO NOT BUY — DO NOT RE-BUY
- No prior position. Current price $110.08.
...
- Fully exited June 5 at $207.80. Current price $212.41. **Above our prior sell price.**
...
### HOOD — DO NOT BUY
- Up +17.20% 1W. No clear catalyst beyond crypto beta.
- Chasing a strong run. Avoid.

### GLD / EIS / SHLD / QTUM / ARKX — DO NOT BUY
- Risk-on tape. No edge. No catalysts. Thin liquidity.
- GLD trade count 1, volume 40 at 17:34Z — thin. Limit orders only, or defer.
...
- **If event detector flags MAJOR or CRITICAL event on broad market symbols (SPY, QQQ, SOXX, XLK, SMH), suspend buys and execute protective sells only if stop-loss is breached.** Current classification: NONE at 17:35Z. All buy triggers ACTIVE.
...
- **SOXX:** Thin (3 trades, 295 vol at 17:34Z). Limit orders only.
...
- Reassess QQQ/SOXX fill status. If unfilled, evaluate whether to raise triggers for tomorrow.
...
- If gross exposure remains below 30%, consider aggressive deployment next cycle to close the gap.
