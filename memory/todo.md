# Tactical Todo — Updated 2026-07-06 18:37Z (Monday 2:37 PM ET)
*Updated by hourly strategist. Fresh directives for Monday Jul 6 regular session remainder and into Tuesday Jul 7 pre-market.*
...
- **Account equity / cash / buying power:** $9,692.19 / $2,267.81 / $29,859.49
...
- **Event detector:** NONE at 18:35Z. Market calm.
...
- **Current:** $722.66 (+0.86% unrealized)
...
- **ANTI-CHURN CRITICAL:** QQQ 6th share was bought TODAY at 1:39 PM ET ($721.94 fill). DO NOT SELL QQQ TODAY under any circumstances. Same-day round trip is prohibited.
...
- **Current:** $690.44 (+2.07% unrealized)
...
- **Current:** $374.70 (+0.74% unrealized)
...
- **Concentration:** 11.6% of equity. Under 15% cap. Adding 1 share would push AVGO to ~15.5%, breaching the 15% single-stock cap. No adds authorized today — do NOT chase gap or pullback.
...
- **Current:** $116.69 (+14.96% unrealized, +2.50R)
...
- QQQ $158.82 + VOO $32.92 + AVGO $20.85 + HOOD $32.50 = $245.09 (2.53% of equity). Under 6% daily loss cap.
...
- **Rationale:** Momentum leader with multiple positive catalysts. Pullback to $105 would be a –10.0% dip from current $116.69 and a test of prior resistance-turned-support. R/R = 2:1 ($20 gain to $125 target vs $10 risk to $95 stop). Concentration post-fill = ~11.0% of equity (under 15% cap).
...
### AVGO — DO NOT ADD
- **Reason:** At 11.6% of equity. Adding 1 share would push AVGO to ~15.5%, breaching the 15% single-stock cap. Stock surged +3.8% today on Apple deal news — do NOT chase gap or pullback.
...
### NVDA — DO NOT BUY
- **Reason:** Below 50-day MA. Underperforming SOXX today (+0.60% vs SOXX +2.96%). No edge over AVGO.
...
- **CRITICAL — Ledger CLI price formatting:** When writing `--detail` arguments to `ledger_cli.ts`, use SINGLE QUOTES for any string containing a dollar amount. Bash expands `$105`, `$116`, `$690`, etc. inside double quotes as positional parameters, stripping the leading digit. Example: `--detail 'HOOD $116.69 above $95.00 stop'`. Failure to use single quotes causes price hallucinations and ledger entry rejection.
...
- **Deploy cash selectively.** Gross exposure 76.6% is fine. Target 80–85% only if high-conviction setups fill.
