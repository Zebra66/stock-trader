...
- [ ] Use **account equity ($9,980.01)** as the sizing base. Do **not** size from raw margin buying power.
...
## Existing Positions
- [ ] **HOLD AVGO** — target allocation **~4%** is already filled. **Do not add**. **TRIM / SELL 1 share** above **424.5** if strength extends, or **SELL 1 share** below **408.8** to cut risk.
- [ ] **HOLD QQQ** — target allocation **~7%** is already filled. **Do not add**. **TRIM / SELL 1 share** above **678.0** if strength extends, or **SELL 1 share** below **667.0** to cut risk.
- [ ] **HOLD SOXX** — current size is already near the desired **~9%** target allocation. **Do not add**. **TRIM 1 share** above **470.5** if strength extends, or **SELL 1 share** below **457.0** to cut risk.
- [ ] **HOLD QTUM** — current size is already near the desired **~3%** target allocation. **Do not add**. **TRIM 1 share** above **138.2** if strength extends, or **SELL 1 share** below **133.8** to cut risk.
...
- [ ] **BUY GOOG** only if price reclaims **381.5-382.5** during regular hours and holds with confirmation, or if it breaks above **384.3** with confirmation. Because the latest broker after-hours print was **thin**, require either **regular-hours confirmation** or a **second-source quote check** before acting. Start with **1 share** (~3.8% of equity). **TRIM / SELL GOOG** above **388.5** or **CUT GOOG** below **374.8**.
...
- [x] Account snapshot: **$9,980.01 equity / $7,618.05 cash / $17,598.06 buying power**.
- [x] Current unrealized P&L is **-$19.99** overall (**AVGO -$0.90, QQQ -$1.15, QTUM -$2.58, RKLB -$0.54, SOXX -$14.82**).
