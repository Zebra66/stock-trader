# Tactical Todo — Updated 2026-07-02 18:35Z (Thursday 2:35 PM ET)
*Market OPEN (closes 20:00Z). Next hourly: 2026-07-02 19:35Z (Thursday 3:35 PM ET).*

<!-- Event detector NONE at 18:35Z. Market weak but stabilizing. No protective sells triggered. -->
...
- **Account equity / cash / buying power:** $9,584.56 / $2,523.52 / $29,864.99
- **Gross long exposure:** 73.7% | **Net exposure:** 73.7% | **Cash:** 26.3%
- **Daytrade count:** 0/3 (clean slate)
- **Pattern day trader:** false
- **Open orders:** NONE.
- **Market:** OPEN until 20:00Z. Next hourly: 2026-07-02 19:35Z.
...
- **Realized P&L:** ~+$65.05 (+0.68% of equity). No further sells authorized for HOOD today.
...
- **Current:** $711.29 (–0.57% unrealized)
...
- **Rationale:** Core growth. Above 50-day MA. Breakeven is $715.38. Selling at breakeven or small loss is PROHIBITED without hourly authorization.
- **Concentration:** 37.1% of equity. Under 45% cap. Adding 1 share would push QQQ to ~44.5%, leaving minimal headroom. No adds authorized today.
...
- **Current:** $682.915 (+0.95% unrealized)
...
- **Concentration:** 14.2% of equity. Under 20% cap. Adding 1 share would push VOO to ~21.2%, breaching the 20% non-QQQ ETF cap. No adds.
...
- **Current:** $359.82 (–3.26% unrealized)
...
- **Rationale:** AI chip alpha. Semis weak today but AVGO showing relative strength vs SOXX on weekly. Breakeven is $371.95. Selling at breakeven or small loss is PROHIBITED without hourly authorization.
- **Concentration:** 11.3% of equity. Under 15% cap. Adding 1 share would breach ~14.9% cap. No adds.
- **Liquidity note:** AVGO acceptable (53 trades at 18:34Z). LIMIT ORDER ONLY for any future orders.
...
- **Current:** $99.23 (+1.26% unrealized, +0.19R)
...
- **Rationale:** 5th position. Space-sector thesis ($8B Iridium deal). Pulled back from $107 intraday high. Not at +2R yet. Breakeven is $98.00. Selling at breakeven or small profit is PROHIBITED without hourly authorization.
- **Concentration:** 5.2% of equity. Under 15% single-stock cap.
- **Liquidity note:** RKLB acceptable (34 trades at 18:34Z). Limit orders preferred.
...
- **Current:** $112.63 (+10.97% unrealized, +1.71R)
...
- **Rationale:** Momentum leader. Trim complete at +2R ($114.51). Remaining 5 shares are house money. Positive news: perpetual futures Europe, AI trading platform, global expansion, Robinhood Chain, 1inch integration. Let winner run to $125 target.
...
- QQQ $126.90 + VOO $32.92 + AVGO $65.85 + HOOD $32.50 + RKLB $40.00 = $298.17 (3.11% of equity). Under 6% daily loss cap.

## BUY Triggers — Authorized For Thursday Regular Session

### RKLB — BUY 5 shares if price drops below $95.00
- **Trigger:** Limit BUY 5 shares @ $95.00 (day order, regular session only).
- **Rationale:** Iridium deal thesis intact. Stock pulled back from $107 intraday high to $99.23. $95 is near prior breakout support. R/R = 4:1 ($20 gain to $115 target vs $5 risk to $90 stop). Concentration post-fill = ~10.3% of equity (under 15% cap).
...
- **Rationale:** Momentum leader with multiple positive catalysts. Pullback to $105 would be a 6.8% dip from current $112.63 and a test of prior resistance-turned-support. R/R = 2:1 ($20 gain to $125 target vs $10 risk to $95 stop). Concentration post-fill = ~11.5% of equity (under 15% cap).
- **Entry:** $105.00 | **Stop:** $95.00 | **Target:** $125.00 | **R-multiple:** 2.0R
- **Condition:** Only if event detector is NONE or MINOR at time of trigger. Do NOT buy if event detector is CRITICAL/MAJOR.
- **Rank:** Priority #2 for fresh capital deployment.
- **Note:** If both RKLB and HOOD triggers fill, gross exposure rises to ~84.0% (within 60–90% band). Cash remains ~$1,524. Acceptable.
...
### VOO — DO NOT ADD
- **Reason:** At 14.2% of equity. Adding 1 share would push VOO to ~21.2%, breaching the 20% non-QQQ ETF cap.
- **DO NOT BUY VOO** today.

### AVGO — DO NOT ADD
- **Reason:** At 11.3% of equity. Adding 1 share would breach ~14.9% cap. Also, semis weak.
- **DO NOT BUY AVGO** today.

### RKLB — DO NOT ADD above $100
- **Reason:** Current price $99.23. Only add on pullback to $95.00 as authorized above. Do NOT chase above $100.
- **DO NOT BUY RKLB** above $100 today.

### HOOD — DO NOT ADD above $110
- **Reason:** Current price $112.63. Only add on pullback to $105.00 as authorized above. Do NOT chase above $110.
...
### NVDA — DO NOT BUY
- **Reason:** Below 50-day MA. No edge over AVGO.
...
- **No same-day round trips.** QQQ, VOO, AVGO were bought Jun 29. HOOD was bought Jun 30. RKLB was bought Jul 1. Same-day sell only authorized if hard stop breached AND event detector is CRITICAL/MAJOR AND hourly note explicitly authorizes.
...
- **If both RKLB and HOOD buy triggers fill, do NOT place any additional buy orders today without fresh hourly authorization.** Daily trade budget would be 3/3 used.
...
- **HOOD:** 30 trades at 18:34Z. Acceptable but limit orders preferred.
- **RKLB:** 34 trades at 18:34Z. Acceptable but limit orders preferred.
- **EIS / ARKX / GLD / QTUM:** Very low trade count / volume. Limit orders only.
- **SHLD:** 2 trades at 18:34Z. Limit orders preferred.
- **VOO:** 3 trades at 18:34Z but liquid underlying. Limit orders preferred.
- **SOXX:** 19 trades at 18:34Z. Acceptable but limit orders preferred.
- **AVGO:** 53 trades at 18:34Z. Acceptable but limit orders preferred.
- **QQQ:** 24 trades at 18:34Z. Acceptable but limit orders preferred.
...
## Next Hourly — Thursday Jul 2 19:35Z (3:35 PM ET)
...
- No other buy orders authorized.
- Event detector expected at ~19:07Z. If CRITICAL/MAJOR, evaluate protective sells at hard stops.
- **Watch AVGO $350.** If AVGO breaks below $350 on volume, reassess chip exposure.
- **Watch SOXX $560.** If SOXX breaks below $560 again, reassess chip exposure.
- **Watch HOOD $125.** Let remaining winner run to profit target.
- **Watch RKLB $95.** If trigger fills, add 5 shares to build space position.
