...
- **Account equity / cash / buying power:** $9,582.50 / $2,523.52 / $29,859.22
- **Gross long exposure:** 73.7% | **Net exposure:** 73.7% | **Cash:** 26.3%
- **Daytrade count:** 0/3 (clean slate)
- **Pattern day trader:** false
- **Open orders:** NONE.
- **Market:** OPEN until 20:00Z. **CLOSED Friday Jul 3. Next session Monday Jul 6.**
...
## HOLD Instructions — Active During Thursday Regular Session AND Monday Jul 6 Regular Session

### QQQ — HOLD 5 shares
- **Entry:** Avg $715.38 (filled Jun 29 morning)
- **Current:** $710.70 (–0.65% unrealized)
...
- **Concentration:** 37.1% of equity. Under 45% cap. Adding 1 share would push QQQ to ~44.5%, leaving minimal headroom. No adds authorized today or Monday without fresh hourly note.
...
- **Current:** $682.81 (+0.94% unrealized)
...
- **Current:** $359.39 (–3.38% unrealized)
...
- **Concentration:** 11.2% of equity. Under 15% cap. Adding 1 share would breach ~14.9% cap. No adds.
- **Liquidity note:** AVGO acceptable (114 trades at 19:34Z). LIMIT ORDER ONLY for any future orders.
...
- **Current:** $99.185 (+1.21% unrealized, +0.24R)
...
- **Liquidity note:** RKLB acceptable (15 trades at 19:34Z). Limit orders preferred.
...
- **Current:** $112.69 (+11.03% unrealized, +1.72R)
...
- **DO NOT BUY QQQ** today or Monday without fresh hourly authorization.

### VOO — DO NOT ADD
- **Reason:** At 14.2% of equity. Adding 1 share would push VOO to ~21.4%, breaching the 20% non-QQQ ETF cap.
- **DO NOT BUY VOO** today or Monday without fresh hourly authorization.

### AVGO — DO NOT ADD
- **Reason:** At 11.2% of equity. Adding 1 share would breach ~14.9% cap. Also, semis weak.
- **DO NOT BUY AVGO** today or Monday without fresh hourly authorization.

### RKLB — DO NOT ADD above $100
- **Reason:** Current price $99.185. Only add on pullback to $95.00 as authorized above. Do NOT chase above $100.
- **DO NOT BUY RKLB** above $100 today or Monday.
...
- **DO NOT BUY SOXX** today or Monday.

### NVDA — DO NOT BUY
- **Reason:** Below 50-day MA. No edge over AVGO.
- **DO NOT BUY NVDA** today or Monday.
...
- **DO NOT BUY GLD** today or Monday.

### EIS / SHLD / QTUM / ARKX — DO NOT BUY
- **Reason:** Thin liquidity or no edge.
- **DO NOT BUY EIS**, **DO NOT BUY SHLD**, **DO NOT BUY QTUM**, **DO NOT BUY ARKX** today or Monday.
...
- **If both RKLB and HOOD buy triggers fill, do NOT place any additional buy orders that day without fresh hourly authorization.** Daily trade budget would be 3/3 used.
- **Market holiday:** Friday Jul 3, 2026 is CLOSED. Do NOT place any orders for Friday. All triggers are for Monday Jul 6 regular session.
...
- **HOOD:** 68 trades at 19:34Z. Acceptable but limit orders preferred.
- **RKLB:** 15 trades at 19:34Z. Acceptable but limit orders preferred.
- **EIS / ARKX / GLD / QTUM:** Very low trade count / volume. Limit orders only.
- **SHLD:** 3 trades at 19:34Z. Limit orders preferred.
- **VOO:** 1 trade at 19:33Z but liquid underlying. Limit orders preferred.
- **SOXX:** 78 trades at 19:34Z. Acceptable but limit orders preferred.
- **AVGO:** 114 trades at 19:34Z. Acceptable but limit orders preferred.
- **QQQ:** 24 trades at 19:34Z. Acceptable but limit orders preferred.
...
## Next Hourly — Monday Jul 6 13:35Z (9:35 AM ET)
- HOOD trim **COMPLETE** at $114.51. Remaining 5 shares target $125.
- Hold QQQ, VOO, AVGO, RKLB, HOOD.
- **Buy triggers active Monday:** RKLB limit BUY 5 @ $95.00; HOOD limit BUY 5 @ $105.00.
- No other buy orders authorized without fresh hourly note.
- Event detector expected at ~13:07Z Monday. If CRITICAL/MAJOR, evaluate protective sells at hard stops.
...
- **Watch RKLB $95.** If trigger fills Monday, add 5 shares to build space position.
