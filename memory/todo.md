...
- **Account equity / cash:** $9,570.92 / $2,267.79
- **Gross long exposure:** 76.3% | **Net exposure:** 76.3% | **Cash:** 23.7%
- **Daytrade count:** 0/3 (clean slate)
- **Pattern day trader:** false
- **Open orders:** NONE.
- **Market:** OPEN. Event detector MINOR at 19:35Z.
- **Daily trade budget:** 0/3 used today (Jul 7).
- **Event detector:** MINOR at 19:35Z. Broad market stable in last 5 min. Semis weak on daily timeframe. No sector rotation.
...
- **Current (positions API):** $708.57 (–1.10% unrealized)
...
- **Rationale:** Core growth. Testing 50D SMA ($711.74). Price at $708.57 is already slightly below 50D. Watch $705–$710 support zone. 44.4% of equity, near 45% cap.
...
- **Current (positions API):** $686.69 (+1.51% unrealized)
...
- **Current (positions API):** $370.02 (–0.52% unrealized)
- **Stop:** $365.00 (hard disaster stop). Price $370.02, $5 above stop. Stop remains active.
- **Profit target:** $420.00. Do NOT trim or sell below $420 without fresh hourly authorization.
- **Rationale:** AI chip alpha. China chip pressure (DeepSeek AI chip, domestic budgets up) is medium-term headwind. Hold with tight stop.
...
- **Current (positions API):** $113.65 (+11.97% unrealized est., +2.4R)
...
- **Rationale:** Momentum leader with multiple positive catalysts. Pullback to $105 would be a –7.6% dip from current $113.65 and a test of prior resistance-turned-support. R/R = 2.0 ($20 gain to $125 target vs $10 risk to $95 stop). Concentration post-fill = ~11.0% of equity (under 15% cap).
...
- **STATUS: ACTIVE.** Place limit order if trigger conditions met.
...
### VOO — DO NOT ADD
- **Reason:** At 14.3% of equity. Adding 1 share would push VOO to ~21.6%, breaching the 20% non-QQQ ETF cap.
...
### GOOG — DO NOT BUY
- **Reason:** Showing relative strength (+3.21% 1W) but still below 50D ($369.36). Volume very light. Needs 50D reclaim on volume > 150% of average AND headline clarity for conviction. Not authorized today.
...
- **CRITICAL — Stop-level authority:** The hourly strategist's hard stop levels are the ONLY authorized stop levels. The tactical agent must NEVER use stop levels from stale tactical memory, prior-cycle notes, or its own internal calculations.
...
## Next Hourly — Tuesday Jul 7 20:35Z (4:35 PM ET)
...
- Event detector expected at next tactical windows (15:40, 15:50 ET). If CRITICAL/MAJOR downward, evaluate protective sells at hard stops.
- **Watch AVGO $365.** Stop active. China chip pressure = elevated risk of another breach.
- **Watch HOOD $125.** Let remaining winner run to profit target.
- **Watch QQQ $705–$710.** 50D support zone at $711.74. Price already below 50D at $708.57. If it breaks decisively below $705 on volume, reassess core allocation (potential trim of 1 share to reduce concentration risk, but do not full-exit into potential bounce).
