...
- Weight 14.18%, below 20% non-QQQ ETF cap. Adding 1 share at current price (~$694.09) would breach cap (~21.3% of equity = code-rejected).
...
- Current price ~$628.41. Market up +9.98% 1W. Do NOT chase.
...
- **Concentration cap check:** SOXX max 20% of equity = $1,959.54. Buying 1 share at $575.00 = 5.87% of equity. Well within cap.
- **Buying at $575 is NOT chasing.** It is 8.50% below current and is a confirmed pullback entry.
- **Illiquidity warning:** SOXX is thin (4 trades, 203 vol at 18:36Z). Limit orders only. No market orders. Maximum 1 SOXX order authorized; do not place additional orders.
...
- **Position:** 1 share filled at $391.43 (16:47Z). Current price $394.04.
- Post-earnings correction deepening. Down –10.44% 1M.
...
- **Concentration cap check:** AVGO max 15% of equity = $1,469.66. Current position 1 share = 4.02% of equity. Well within cap.

### RKLB — DO NOT BUY — DO NOT RE-BUY
- No prior position. Current price $109.16.
...
- Fully exited June 5 at $207.80. Current price $211.93. **Above our prior sell price.**
...
### HOOD — DO NOT BUY
- Up +16.80% 1W. No clear catalyst beyond crypto beta.
...
- **SOXX:** Thin (4 trades, 203 vol at 18:36Z). Limit orders only.
