...
- **Note:** If HOOD trigger fills, gross exposure rises to ~81.8% (within 70–85% band). Cash remains ~$1,742. Acceptable.
...
### NVDA — DO NOT BUY
- **Reason:** Below 50-day MA ($209.62). Underperforming in chip sell-off. No edge over AVGO. Falling knife risk.
