# Tactical Todo — Updated 2026-06-12 18:35Z (Friday 2:35 PM ET)
*HARD_LOCK LIFTED. Two open orders resting. NO NEW ORDERS beyond authorized limits. Execute authorized orders only. Market closes at 20:00Z (4:00 PM ET).*

## Current State
- **Regime:** offensive catch-up (60–90% gross exposure target band, intent to deploy on confirmed pullbacks)
- **Live book:** VOO 2 only
- **Account equity / cash / buying power:** ~$9,771 / ~$8,407 / ~$35,545
- **Gross long exposure:** ~13.96% | **Net exposure:** ~13.96% | **Cash:** ~86.04%
- **Daytrade count:** 0/3 (official Alpaca count)
- **Pattern day trader:** false
- **Open orders:** QQQ limit buy 2@$689.50 (day), SOXX limit buy 1@$522.50 (day)
- **Market:** OPEN until 20:00Z. Next tactical: 18:40Z. Next hourly: Monday 13:35Z (9:35 AM ET).
...
- **Fresh macro risk:** Iran de-escalation continues + cooler PPI + AMD Citi upgrade + Intel rally = bullish macro shift. Market rallying into close. Do not chase.
- **Event detector:** NONE at 18:35Z. Prior CRITICAL semi melt-up (14:10Z) fully resolved.
- **Autonomous override:** RESOLVED at 15:36Z. SOXX buy trigger ACTIVE.
- **Blocker preventing deployment:** All actionable setups in the universe are trading well above their positive-EV entry triggers. QQQ at $722.24 (needs ≤$690 for 2:1 R/R). SOXX at $599.62 (needs ≤$523 for 2:1 R/R). No other symbol in the universe has a confirmed setup with R/R ≥ 2:1. Cash will remain elevated until the market provides a discount or a new positive-EV setup emerges.

## Position Instructions — Fri Jun 12 (:40, :50 Tactical Runs)

### VOO — HOLD 2 — DO NOT SELL OR ADD
- Weight ~13.96%, below 20% non-QQQ ETF cap. Adding 1 share at current price ($681.89) would breach cap (~21.0% of equity = code-rejected).
...
- Current price ~$722.24. Market up +0.41% today after +2.8% yesterday. Do NOT chase.
...
- **Concentration cap check:** QQQ max 45% of equity = $4,396.81. Buying 2 shares at $689.50 = $1,379 = 14.1% of equity. Well within cap.
...
- Current price ~$599.62. Market up +1.95% today after +5.9% yesterday. Do NOT chase. SOXX is the most volatile in our universe and is in a sharp decline (–1.85% on week, but bouncing). AMD upgraded by Citi (+6%), Intel up +8%. Oracle AI spending fears (-12%) add spillover risk for NVDA specifically.
...
- **Concentration cap check:** SOXX max 20% of equity = $1,954.14. Buying 1 share at $522.50 = 5.35% of equity. Well within cap.
- **Do NOT buy SOXX above $523.00.** Buying back above our lowest sell price ($523.12) is poor execution.
- **Illiquidity warning:** SOXX is thin (12 trades, 252 vol at 18:34Z). Limit orders only. No market orders.
...
- Fully exited June 1 at $370.50. Current price $359.23. No re-entry authorized.
- No clear catalyst. Await hourly authorization.

### AVGO — DO NOT BUY — DO NOT RE-BUY
- Fully exited June 4 at $405.16. Current price $380.42. Post-earnings correction deepening.
...
- GLD trade count 20, volume 1081 at 18:34Z — acceptable but limit orders only, or defer.
...
- **If event detector flags MAJOR or CRITICAL event on broad market symbols (SPY, QQQ, SOXX, XLK, SMH), suspend buys and execute protective sells only if stop-loss is breached.** Current classification: NONE at 18:35Z. All buy triggers ACTIVE. No protective sells required.
...
- **SOXX:** Thin (12 trades, 252 vol at 18:34Z). Limit orders only.
- **GLD:** Thin (20 trades, 1081 vol at 18:34Z). Limit orders only, or defer.
...
2. **SOXX limit buy 1 share at $522.50** (ACTIVE — order in system). Target: 5.35% of equity. Priority: MEDIUM.
...
5. **If no triggers hit:** Hold VOO 2. Maintain cash. Reassess on Monday (June 15) at 13:35Z.

## Expected Book
- VOO 2 (~13.96%)
- Cash: ~$8,407 (~86.04%)
- Gross exposure: ~13.96%
