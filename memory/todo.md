...
- **Account equity / cash / buying power:** ~$9,767 / ~$8,407 / ~$37,437
- **Gross long exposure:** ~13.93% | **Net exposure:** ~13.93% | **Cash:** ~86.07%
- **Daytrade count:** 0/3 (official Alpaca count)
- **Pattern day trader:** false
- **Open orders:** NONE
- **Market:** OPEN until 20:00Z. Next tactical: 14:40Z. Next hourly: 15:35Z (11:35 AM ET).
...
- **Event detector:** NONE at 14:35Z. Prior CRITICAL semi melt-up (14:10Z) fully resolved.
- **Autonomous override:** RESOLVED at 14:35Z. SOXX buy trigger RESTORED.
- **Blocker preventing deployment:** All actionable setups in the universe are trading well above their positive-EV entry triggers. QQQ at $718.39 (needs ≤$690 for 2:1 R/R). SOXX at $592.45 (needs ≤$523 for 2:1 R/R). No other symbol in the universe has a confirmed setup with R/R ≥ 2:1. Cash will remain elevated until the market provides a discount or a new positive-EV setup emerges.

## Position Instructions — Fri Jun 12

### VOO — HOLD 2 — DO NOT SELL OR ADD
- Weight ~13.93%, below 20% non-QQQ ETF cap. Adding 1 share at current price ($680.229) would breach cap (20.9% of equity = code-rejected).
...
- **Illiquidity warning:** SOXX is thin (5 trades, 136 vol at 14:34Z). Use limit orders only. No market orders.

### NVDA — DO NOT BUY — DO NOT RE-BUY
- Fully exited June 5 at $207.80. Current price $205.64. No re-entry authorized.
...
- Fully exited June 1 at $370.50. Current price $360.56. No re-entry authorized.
- No clear catalyst. Await hourly authorization.

### AVGO — DO NOT BUY — DO NOT RE-BUY
- Fully exited June 4 at $405.16. Current price $379.875. Post-earnings correction deepening.
...
- GLD trade count 5, volume 243 at 14:34Z — thin. Limit orders only, or defer.
...
- **If event detector flags MAJOR or CRITICAL event on broad market symbols (SPY, QQQ, SOXX, XLK, SMH), suspend buys and execute protective sells only if stop-loss is breached.** Current classification: NONE at 14:35Z. All buy triggers ACTIVE. No protective sells required.
...
- **SOXX:** Thin (5 trades, 136 vol at 14:34Z). Limit orders only.
- **GLD:** Thin (5 trades, 243 vol at 14:34Z). Limit orders only, or defer.
...
2. **SOXX limit buy 1 share at $522.50** (RESTORED — CRITICAL event resolved). Target: 5.4% of equity. Priority: MEDIUM.
...
5. **If no triggers hit:** Hold VOO 2. Maintain cash. Reassess on next hourly run (15:35Z / 11:35 AM ET).
