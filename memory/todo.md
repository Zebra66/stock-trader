...
- **Current:** $728.22 (+1.79% unrealized)
...
- **Current:** $686.66 (+1.51% unrealized)
...
- **Current:** $372.07 (+0.03% unrealized)
...
- **Rationale:** AI chip alpha. Showing relative strength vs SOXX rout (–1.5% vs –5.2%). Breakeven is $371.95. Selling at breakeven or small loss is PROHIBITED without hourly authorization.
- **Concentration:** 11.5% of equity. Under 15% cap. Adding 1 share would breach 15.2%. No adds.
- **Liquidity note:** AVGO thin but improved (50 trades at 19:34Z). LIMIT ORDER ONLY for any future orders.
...
- **Current:** $109.24 (+7.63% unrealized)
...
- **Rationale:** 4th position. Strong 1M/3M momentum. Surging today +8.94%. Breakeven is $101.50. Selling at breakeven or small profit is PROHIBITED without hourly authorization.
- **Concentration:** 11.3% of equity. Under 15% cap. Adding 1 share would add ~1.1% to weight. No adds authorized today.
- **Liquidity note:** HOOD improved (63 trades at 19:34Z). LIMIT ORDER ONLY.
...
- **Current:** $101.93 (+4.01% unrealized)
...
- **Profit target:** $115.00. Do NOT trim or sell below $115 without fresh hourly authorization.
- **Rationale:** 5th position. Space-sector M&A thesis ($8B Iridium deal). Wedbush "best time in a generation" for space/defense validates. Pullback from $106.54 to $101.93 is normal profit-taking. Breakeven is $98.00. Selling at breakeven or small profit is PROHIBITED without hourly authorization.
- **Concentration:** 5.3% of equity. Under 15% single-stock cap.
- **Liquidity note:** RKLB acceptable (64 trades at 19:34Z). Limit orders preferred.
- **AUTHORIZE SAME-DAY SELL RKLB if price breaches $90.00 AND event detector is CRITICAL/MAJOR**

### Total Portfolio Heat
- QQQ $126.90 + VOO $32.92 + AVGO $65.85 + HOOD $65.00 + RKLB $40.00 = $330.67 (3.41% of equity). Under 6% daily loss cap.
...
### HOOD — DO NOT ADD
- **Reason:** At 11.3% of equity. No add authorized today.
- **DO NOT BUY HOOD** today.

## DO NOT BUY — Symbols Blocked This Cycle

### SOXX — DO NOT BUY
- **Reason:** Down –5.23% today. Prior close $640.76, current ~$607.27. Watch $600/$590. Do NOT buy into a falling knife. Overlaps QQQ/AVGO.
...
- **HOOD:** 63 trades at 19:34Z. Improved but limit orders preferred.
- **RKLB:** 64 trades at 19:34Z. Acceptable but limit orders preferred.
- **EIS / ARKX / GLD / QTUM:** Very low trade count / volume. Limit orders only.
- **SHLD:** 4 trades at 19:33Z. Limit orders preferred.
- **VOO:** 3 trades at 19:34Z but liquid underlying. Limit orders only.
- **SOXX:** 15 trades at 19:34Z. Acceptable but limit orders preferred.
- **AVGO:** 50 trades at 19:34Z. Improved but limit orders preferred.
...
## Next Hourly — Thursday Jul 2 13:35Z (9:35 AM ET)
- Hold all 5 current positions.
- No new buy orders unless a new hourly note explicitly authorizes a 6th position or add.
- Event detector expected at ~13:07Z. If CRITICAL/MAJOR, evaluate protective sells at hard stops.
- **Watch SOXX $600.** If SOXX closes below $600 today or gaps below it tomorrow, hourly strategist will reassess chip exposure.
